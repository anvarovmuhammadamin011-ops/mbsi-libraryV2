            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="truncate text-sm font-medium">{userMap.get(e.userId) ?? "Unknown"}</p>
                  <p className="text-xs text-muted-foreground">{e._count.id} books</p>
                </div>
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Platform reading leaderboard</p>
      </div>

      <Tabs defaultValue="students">
        <TabsList className="w-full sm:w-auto">
          <TabsTrigger value="students" className="flex-1 sm:flex-none">Students</TabsTrigger>
          <TabsTrigger value="teachers" className="flex-1 sm:flex-none">Teachers</TabsTrigger>
        </TabsList>
